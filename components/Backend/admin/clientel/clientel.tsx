...
import Addclientel from "./addclientel";
import Editclientel from "./editclientel";
import Viewclientel from "./viewclientel";
...
export default function Clientel() {
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      const { error } = await supabase.from("clientel").delete().eq("id", id);
