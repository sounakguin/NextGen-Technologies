...
import AddServicesWhatMakesUsDifferent from "./addwhatmakeusdifferent";
import EditServicesWhatMakesUsDifferent from "./editwhatmakeusdifferent";
import ViewServicesWhatMakesUsDifferent from "./viewwhatmakeusdifferent";
...
export default function ServicesWhatMakesUsDifferent() {
  ...
  return (
    <div className="container mx-auto p-6 bg-gray-50 min-h-screen">
      ...
      {isAddModalOpen && (
        <AddServicesWhatMakesUsDifferent
      ...
      {isEditModalOpen && currentItem && (
        <EditServicesWhatMakesUsDifferent
          item={currentItem}
      ...
      {isViewModalOpen && currentItem && (
        <ViewServicesWhatMakesUsDifferent
          item={currentItem}
