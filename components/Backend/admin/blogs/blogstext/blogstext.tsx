...
import Addblogtext from "./addblogstext";
import Editblogtext from "./editblogstext";
import Viewblogtext from "./viewblogstext";
...
export default function Blogtext() {
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      const { error } = await supabase.from("blogtext").delete().eq("id", id);
