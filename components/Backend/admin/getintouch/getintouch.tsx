...
import Addgetintouch from "./addgetintouch";
import Editgetintouch from "./editgetintouch";
import Viewgetintouch from "./viewgetintouch";
...
export default function Getintouch() {
  ...
  const handleDelete = async (id: number) => {
    ...
    try {
      const { error } = await supabase.from("getintouch").delete().eq("id", id);
