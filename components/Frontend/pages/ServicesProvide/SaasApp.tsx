...
interface SaasApp {
  ...
  title: string;
  slug: string;
  description?: string; // Make description optional to match the updated interface
}
...
interface SaasAppProps {
  saasApp: SaasApp;
  templates: SaasAppTemplate[];
  categories?: SaasAppCategory[]; // Make categories optional
}
...
export default function SaasApp({
  ...
  // Safely handle the description which might be undefined
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex mb-6 text-sm text-gray-500">
        ...
        <span className="text-primary">SaaS App</span>
      </div>

      {/* Hero Section */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold mb-4">
          Get a Fully Customized {saasApp.title}
        </h1>
        <div className="text-gray-600 max-w-3xl">
          <TextFormatter description={safeDescription} />
        </div>
      </div>
