...
interface WebTemplatesProps {
  ...
  templates: WebTemplateTemplate[];
  categories?: WebTemplateCategory[]; // Make categories optional
}
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-12">
        <h1 className="text-4xl font-bold mb-4">
          Get a Fully Customized {webTemplate.title}
        </h1>
        <div className="text-gray-600 max-w-3xl">
          <TextFormatter description={webTemplate.description} />
        </div>
      </div>
